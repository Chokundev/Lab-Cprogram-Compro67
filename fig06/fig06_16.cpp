...
int main(void)
{
	...
	/* initialize array response */ int response[SIZE] =
	{ 6, 7, 8, 9, 8, 7, 8, 9, 8, 9,
	  7, 8, 9, 5, 9, 8, 7, 8, 7, 8,
	  6, 7, 8, 9, 3, 9, 8, 7, 8, 7,
	  7, 8, 9, 8, 9, 8, 9, 7, 8, 9,
...
/* determine most frequent response */
	...
	/* function that sorts an array with bubble sort algorithm */ void bubbleSort(int a[])
	{
		...
		for (pass = 1; pass < SIZE; pass++) {
			/* loop to control number of comparisons per pass */ for (j = 0; j < SIZE - 1; j++) {
	...
	/* output array contents (20 values per row) */ void printArray(const int a[])
	{
		int j; /* counter */
